...
{:name => "Buy2.buy2_cron", :time => "30 5 * * *", :command => "cd /data/konimboil/current && RAILS_ENV=production bundle exec rake backup:run trigger='production-backup-s3-every-day-ey'", :instance_name => "cron"}]
